...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Envora — Construction Materials in The Gambia" },
      { property: "og:description", content: "Order construction materials directly from trusted suppliers." },
